...
module.exports =
{
    ...
    async execute(client, message, args, Discord)
    {
        ...
        let botMessage = fs.readFileSync(`txt/${this.name}.txt`, 'utf8').replace(/{tournament}/g, tournament).replace(/{screenshots}/g, msg.guild.channels.cache.get('894372076884992015'));
...
function errorMessage()
{
    const embedMessage = new dc.MessageEmbed()
        ...
        .addField('Required Syntax', `oqck tournament`, false)
